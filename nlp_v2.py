...
X_train, X_test, y_train, y_test = train_test_split(corpus, label, test_size=0.3, random_state=1)
...
t0 = time()
print("开始")
TfidfVec = pickle.load(open("model/Tfidf_model_min3.pkl", "rb"))
wv = KeyedVectors.load("model/word2vec_15000.wv", mmap="r")
